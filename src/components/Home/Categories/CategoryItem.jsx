    ...
    return (
        <div className="my-12 lg:my-30 px-4 lg:px-40 flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Link to="/pets"><div className="hover:blur-[2px] cursor-pointer transition-all duration-300"><img src={catImage} alt="Cat Image" className="w-94 h-76 rounded-sm object-cover object-top" /></div></Link>
                <Link to="/pets"><div className="hover:blur-[2px] cursor-pointer transition-all duration-300"><img src={dgoImage} alt="Cat Image" className="w-94 h-76 rounded-sm object-cover object-top" /></div></Link>
                <Link to="/pets"><div className="hover:blur-[2px] cursor-pointer transition-all duration-300"><img src={rabitImage} alt="Cat Image" className="w-94 h-76 rounded-sm object-cover object-top" /></div></Link>
                <Link to="/pets"><div className="hover:blur-[2px] cursor-pointer transition-all duration-300"><img src={birdImage} alt="Cat Image" className="w-94 h-76 rounded-sm object-cover object-top" /></div></Link>
            </div>
